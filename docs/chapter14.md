...
![DPI-Cデータ型マッピング](../images/ch14_dpi_type_mapping.drawio.png)
...
![DPI-Cビルドフロー](../images/ch14_dpi_build_flow.drawio.png)
...
![ファクトリパターンのクラス図](../images/ch14_factory_pattern.drawio.png)
