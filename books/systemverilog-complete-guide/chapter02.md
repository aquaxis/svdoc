...
![シミュレータの分類と特徴](/images/books/systemverilog-complete-guide/ch02_simulator_overview.drawio.png)
...
![コンパイルからシミュレーション実行までのワークフロー](/images/books/systemverilog-complete-guide/ch02_workflow.drawio.png)
