...
![FSMの2プロセスパターン](/images/ch16_fsm_two_process.drawio.png)
...
![ハンドシェイクプロトコルのタイミング](/images/ch16_handshake_timing.drawio.png)
...
### 16.3.1 階層化テストベンチパターン

階層化テストベンチでは、テストベンチを機能ごとのレイヤーに分割します。

![階層化テストベンチの構造](/images/ch16_layered_testbench.drawio.png)
...
![再利用可能なコンポーネント設計の構造](/images/ch16_reusable_components.drawio.png)

---

## 16.5 コーディングベストプラクティス
...
![よくある落とし穴の分類](/images/ch16_common_pitfalls.drawio.png)

---

## 16.7 UVM（Universal Verification Methodology）概要
...
![UVMアーキテクチャ](/images/ch16_uvm_architecture.drawio.png)
