...
![DPI-Cのアーキテクチャ](/books/systemverilog-complete-guide/images/ch14_dpi_architecture.drawio.png)
...
![DPI-Cデータ型マッピング](/books/systemverilog-complete-guide/images/ch14_dpi_type_mapping.drawio.png)
...
![DPI-Cビルドフロー](/books/systemverilog-complete-guide/images/ch14_dpi_build_flow.drawio.png)
...
![ファクトリパターンのクラス図](/books/systemverilog-complete-guide/images/ch14_factory_pattern.drawio.png)
