...
![DPI-Cのアーキテクチャ](/images/books/systemverilog-complete-guide/ch14_dpi_architecture.drawio.png)
...
![DPI-Cデータ型マッピング](/images/books/systemverilog-complete-guide/ch14_dpi_type_mapping.drawio.png)
...
![DPI-Cビルドフロー](/images/books/systemverilog-complete-guide/ch14_dpi_build_flow.drawio.png)
...
![ファクトリパターンのクラス図](/images/books/systemverilog-complete-guide/ch14_factory_pattern.drawio.png)
