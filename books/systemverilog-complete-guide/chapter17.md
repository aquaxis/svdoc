...
## 17.4 プロジェクト2：簡易CPU設計

### 17.4.1 命令セットアーキテクチャ（ISA）
...
[前の章へ](chapter16.md) | [次の章へ](chapter18.md)
