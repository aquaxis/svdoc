...
![デザインパターンの全体像](/images/books/systemverilog-complete-guide/ch16_design_patterns_overview.drawio.png)
...
![FSMの2プロセスパターン](/images/books/systemverilog-complete-guide/ch16_fsm_two_process.drawio.png)
...
![ハンドシェイクプロトコルのタイミング](/images/books/systemverilog-complete-guide/ch16_handshake_timing.drawio.png)
...
![階層化テストベンチの構造](/images/books/systemverilog-complete-guide/ch16_layered_testbench.drawio.png)
...
![再利用可能なコンポーネント設計の構造](/images/books/systemverilog-complete-guide/ch16_reusable_components.drawio.png)
...
![よくある落とし穴の分類](/images/books/systemverilog-complete-guide/ch16_common_pitfalls.drawio.png)
...
![UVMアーキテクチャ](/images/books/systemverilog-complete-guide/ch16_uvm_architecture.drawio.png)
