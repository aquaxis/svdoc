...
![デザインパターンの全体像](/books/systemverilog-complete-guide/images/ch16_design_patterns_overview.drawio.png)
...
![FSMの2プロセスパターン](/books/systemverilog-complete-guide/images/ch16_fsm_two_process.drawio.png)
...
![ハンドシェイクプロトコルのタイミング](/books/systemverilog-complete-guide/images/ch16_handshake_timing.drawio.png)
...
![階層化テストベンチの構造](/books/systemverilog-complete-guide/images/ch16_layered_testbench.drawio.png)
...
![再利用可能なコンポーネント設計の構造](/books/systemverilog-complete-guide/images/ch16_reusable_components.drawio.png)
...
![よくある落とし穴の分類](/books/systemverilog-complete-guide/images/ch16_common_pitfalls.drawio.png)
...
![UVMアーキテクチャ](/books/systemverilog-complete-guide/images/ch16_uvm_architecture.drawio.png)
