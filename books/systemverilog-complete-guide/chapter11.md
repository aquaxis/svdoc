...
![fork-joinの3つのバリエーション](/images/books/systemverilog-complete-guide/ch11_fork_join_variants.drawio.png)
...
![mailboxのプロデューサ・コンシューマパターン](/images/books/systemverilog-complete-guide/ch11_mailbox_pattern.drawio.png)
