...
![fork-joinの3つのバリエーション](/books/systemverilog-complete-guide/images/ch11_fork_join_variants.drawio.png)
...
![mailboxのプロデューサ・コンシューマパターン](/books/systemverilog-complete-guide/images/ch11_mailbox_pattern.drawio.png)
