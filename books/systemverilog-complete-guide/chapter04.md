...
![配列の種類と特徴の概要](/books/systemverilog-complete-guide/images/ch04_array_overview.drawio.png)
...
![静的配列・動的配列・連想配列のメモリ配置の比較](/books/systemverilog-complete-guide/images/ch04_array_memory_layout.drawio.png)
...
![パック配列とアンパック配列のメモリ配置](/books/systemverilog-complete-guide/images/ch04_packed_vs_unpacked.drawio.png)
