...
![配列の種類と特徴の概要](/images/books/systemverilog-complete-guide/ch04_array_overview.drawio.png)
...
![静的配列・動的配列・連想配列のメモリ配置の比較](/images/books/systemverilog-complete-guide/ch04_array_memory_layout.drawio.png)
...
![パック配列とアンパック配列のメモリ配置](/images/books/systemverilog-complete-guide/ch04_packed_vs_unpacked.drawio.png)
