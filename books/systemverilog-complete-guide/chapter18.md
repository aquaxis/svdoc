...
![プロジェクト演習の全体構成](/images/books/systemverilog-complete-guide/ch17_project_overview.drawio.png)
...
![設計・検証フロー](/images/books/systemverilog-complete-guide/ch17_design_verification_flow.drawio.png)
...
![UARTフレームフォーマット](/images/books/systemverilog-complete-guide/ch17_uart_frame_format.drawio.png)
...
![UARTモジュール構成](/images/books/systemverilog-complete-guide/ch17_uart_module_structure.drawio.png)
...
![簡易CPU命令フォーマット](/images/books/systemverilog-complete-guide/ch17_cpu_instruction_format.drawio.png)
...
![簡易CPUブロック図](/images/books/systemverilog-complete-guide/ch17_cpu_block_diagram.drawio.png)
...
![SPIバス接続図](/images/books/systemverilog-complete-guide/ch17_spi_bus_connection.drawio.png)
...
![デバッグフロー](/images/books/systemverilog-complete-guide/ch17_debug_flow.drawio.png)
