...
![プロジェクト演習の全体構成](/books/systemverilog-complete-guide/images/ch17_project_overview.drawio.png)
...
![設計・検証フロー](/books/systemverilog-complete-guide/images/ch17_design_verification_flow.drawio.png)
...
![UARTフレームフォーマット](/books/systemverilog-complete-guide/images/ch17_uart_frame_format.drawio.png)
...
![UARTモジュール構成](/books/systemverilog-complete-guide/images/ch17_uart_module_structure.drawio.png)
...
![簡易CPU命令フォーマット](/books/systemverilog-complete-guide/images/ch17_cpu_instruction_format.drawio.png)
...
![簡易CPUブロック図](/books/systemverilog-complete-guide/images/ch17_cpu_block_diagram.drawio.png)
...
![SPIバス接続図](/books/systemverilog-complete-guide/images/ch17_spi_bus_connection.drawio.png)
...
![デバッグフロー](/books/systemverilog-complete-guide/images/ch17_debug_flow.drawio.png)
